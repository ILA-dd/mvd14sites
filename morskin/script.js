...
const STORAGE_LAST_SPIN = 'morskin_mm2_last_spin';
const STORAGE_HISTORY = 'morskin_mm2_win_history';
const STORAGE_USERNAME = 'morskin_mm2_username';
const STORAGE_VISITOR_ID = 'morskin_mm2_visitor_id';
...
function showGroupModal() {
  ...
  document.getElementById('groupManualBtn').addEventListener('click', function() {
    groupJoined = true;
    try { localStorage.setItem('morskin_group_joined', '1'); } catch(e) {}
...
(function restoreGroupState() {
  try { if (localStorage.getItem('morskin_group_joined') === '1') groupJoined = true; } catch(e) {}
})();
...
try {
  ...
  console.error('MorSkin init error:', err);
}
